...
class MyTxApp extends StatefulWidget {
  final String url;
  MyTxApp({this.url="http://200024424.vod.myqcloud.com/200024424_709ae516bdf811e6ad39991f76a4df69.f20.mp4"});
  @override
  _MytxAppState createState() => _MytxAppState();
}

class _MytxAppState extends State<MyTxApp> {
  ...
  void initState() {
    ...
    controller = VideoPlayerController.path(widget.url)
      ..initialize();
