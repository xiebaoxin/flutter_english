                ...
                default: //如果_calculation执行完毕
                  if (snapshot.hasError) //若_calculation执行出现异常
                    ...
                    if (snapshot.hasData) {
                      ...
                      num count0=acountinfo['count0']??0;
                      num count1=acountinfo['count1']??0;
                      return   Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Text("总额：${count0.toString()}",style: KfontConstant.bigfontSize,),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(18.0),
                                child: Text("已提：${count1.toString()}",style: KfontConstant.bigfontSize,),
                              ),
                    ...
                    Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (context) => new reChargePage()),
                              ...
                              const SizedBox(height: 10.0),
                              ComFunUtil().buildMyButton(context, '提现', () {
                                Navigator.push(
                                  context,
                                  new MaterialPageRoute(
                                      builder: (context) => new WithdrawalPage(type: 0,max: acountinfo['count0']-acountinfo['count1'],)),
                                ).then((response) async {
